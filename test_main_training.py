...
if not os.path.exists("./result/main_train"):
  os.makedirs("./result/main_train")
...
#----------------------------------------------------------------------------
np.savetxt("./result/main_train/result_row.csv" ,result_matrix, delimiter=',',fmt='%s')
#---------------------------------------------------------------------------

"""WSIs predict"""

#----------------------------------------------------------------------------
lst = pd.read_csv("./result/main_train/result_row.csv").values.tolist()
#----------------------------------------------------------------------------
...
#----------------------------------------------------------------------------
np.savetxt("./result/main_train/result_WSIs.csv" ,val_score ,delimiter=',',fmt='%s')
#----------------------------------------------------------------------------
print("Completed.")


#----------------------------------------------------------------------------
lst = pd.read_csv("./result/main_train/result_WSIs.csv" ).values.tolist()
#----------------------------------------------------------------------------
label_class = []
for i in range(len(lst)):
  if "N" in lst[i][0] :
...
def print_cmx(y_true, y_pred):
    ...
    #-------------------------------------------------------------------------
    plt.savefig("./result/main_train/result_main_training_CM_rate.tiff", format="tiff", dpi=300)
    #-------------------------------------------------------------------------
    plt.show()
...
def print_cmx(y_true, y_pred):
    ...
    plt.savefig("./result/main_train/result_main_training_CM_image.tiff", format="tiff", dpi=300)
    plt.show()
