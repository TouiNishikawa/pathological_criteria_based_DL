...
if not os.path.exists("./log/cnn" + str(cnn_num)):
  os.makedirs("./log/cnn" + str(cnn_num))

loss_history = hist.history["val_loss"]
numpy_loss_history = numpy.array(loss_history)
numpy.savetxt("./log/cnn" + str(cnn_num) + "/loss_history.txt", numpy_loss_history, delimiter=",")

acc_history = hist.history["val_accuracy"]
numpy_acc_history = numpy.array(acc_history)
numpy.savetxt("./log/cnn" + str(cnn_num) + "/acc_history.txt", numpy_acc_history, delimiter=",")
